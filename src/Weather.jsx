...
export default function Weather({searchvalue,name,temp,description,windSpeed,humidity,sunrise,main,cod}) {
  ...
  return (
    <section className="vh-100 bg-gradient-to-r from-blue-500 to-teal-500 flex items-center justify-center">
      <MDBContainer className="h-100 flex items-center justify-center">
        <MDBRow className="justify-content-center align-items-center h-100 w-full">
          <input
            className="w-full max-w-sm p-2 mb-4 rounded-md shadow-sm border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500"
            onChange={searchvalue}
            type="text"
            placeholder="Enter the location to check the weather"
          />
          <MDBCol md="8" lg="6" xl="4" className="w-full">
            <MDBCard className="bg-white shadow-lg rounded-3xl">
              <MDBCardBody className="p-6">
                ...
                <div className="flex flex-col items-center mt-6 mb-4">
                  ...
                  >
                    {cod==400?'Searching...':(cod==404?'city not found ':temp +'°')}
                  </MDBTypography>
                ...
                <div className="flex justify-around items-center">
                  <div className="text-lg text-gray-600">
                    <div className="flex items-center mb-2">
                      <MDBIcon fas icon="wind fa-fw" className="text-gray-600" />
                      <span className="ml-2">{windSpeed} Km/Hr</span>
                    </div>
                    <div className="flex items-center mb-2">
                      <MDBIcon fas icon="tint fa-fw" className="text-gray-600" />
                      <span className="ml-2">{humidity} %</span>
                    </div>
                    <div className="flex items-center">
                      <MDBIcon fas icon="sun fa-fw" className="text-gray-600" />
